...
import Hero from "../Doctor/Modules/Hero/Hero.module";
import Features from "../Doctor/Modules/Features/Features.module";
import StartWithUs from "./Modules/StartWithUs/StartWithUs.module";
import Presentation from "./Modules/Presentation/Presentation.module";
import Questions from "../Doctor/Modules/Questions/Questions.module";
...
const SolutionsHealth: React.FC<SolutionsHealthProps> = ({ solution }) => {
  ...
  return (
    <main className={styles.solutions__health}>
